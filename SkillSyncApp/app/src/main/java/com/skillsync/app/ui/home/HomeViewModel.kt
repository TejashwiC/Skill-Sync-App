...
class HomeViewModel : ViewModel() {
    ...
    private val sessionRepository = com.skillsync.app.data.repository.SessionRepository()
    ...
    private val _hostedSessionsCount = MutableLiveData<Int>(0)
    val hostedSessionsCount: LiveData<Int> = _hostedSessionsCount
